...
contract DeployedNFT is Script {
    address public myTestContractAddress = 0x7FA9385bE102ac3EAc297483Dd6233D62b3e1496; 
    ...
    //CCIP:
    address routerSepolia = 0xD0daae2231E9CB96b94C8512223533293C3693Bf; //Router Sepolia (Address of the receiver)
    address routerFuji = 0x554472a2720e5e7d5d3c817529aba05eed5f82d8 ; //Router Fuji (Address of the receiver)

    function run() external returns (dNFT) {
        vm.startBroadcast();
        dNFT dnft = new dNFT(mySepoliaAddress,vrfCoordinator,subscriptionId,dataFeedAdress,routerFuji); 
        vm.stopBroadcast();
        return dnft;
    }
}